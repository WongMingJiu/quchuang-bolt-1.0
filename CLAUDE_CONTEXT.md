...
# 当前任务
管理中心下一阶段开发：从 mock 骨架逐步升级为真实数据驱动版本，优先推进团队仪表盘真实数据接入。

# 下一步计划
1. 继续接管理中心真实数据：先团队仪表盘，再个人仪表盘，再权限与额度页
2. 完善成员详情 / 调用详情 / 权限编辑的真实接口联调
3. 在管理中心层补统一 loading / empty / error 状态
4. 视需要继续沉淀 README / delivery / admin 文档
