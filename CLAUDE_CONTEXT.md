...
# 当前任务
资产体系体验增强：重点优化资产详情抽屉的信息分组、下载入口、当前所属类型可见性、非视频占位、以及筛选区域层次，让资产中心更像正式产品。

# 下一步计划
1. 优化 `AssetDetailDrawer` 的信息分组，让基本信息、业务信息、标注信息更清晰
2. 给资产详情抽屉补下载入口与更明确的操作区
3. 优化资产卡片上的资产所属类型可见性与非视频占位
4. 继续整理资产页筛选区域层次，让一级分类、IP二级筛选、媒介筛选和状态反馈更清晰
